...
class CMTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(CMTableViewController.refreshList), name: NSNotification.Name(rawValue: "TodoListShouldRefresh"), object: nil)
    ...
    func configureCell(_ cell: UITableViewCell, withEvent event: Events) {
        ...
        //-Lock the table image size to 45x45
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let CellIdentifier = "CMTableCell"
                ...
                //let event = controller.object(at: indexPath!) as! Events
                    DispatchQueue.main.async {
                        ...
                        if event.textCalendarID == nil {
                            ...
                            print("TableView Update:Calender ID = nil")
                        }
                        else {
                            print("TableView Update:Calendar ID != nil")
                        }
                    }
